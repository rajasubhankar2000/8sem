...
const getInfo =async(event)=>{
    ...
    if(cityVal==""){
        city_name.innerText = `provide city name on search box and search`;
        datahide.classList.add('data_hide');
    }
    else{
        try{
         let url='https://api.openweathermap.org/data/2.5/weather?q=pune&appid=3b6575167ee9eaff1aae3e8948e6ae87';
